...
cd /gpfs/alpine1/scratch/liwh2139/lennard-jones-miniproject/anthracene/new_cutoffs/paper_extra_Sims/1.0-1.2/force_switch/sim_data/sim_3
...
gmx mdrun -deffnm anthracene_fs_1.0_1.2 -nt 12 > step2.log 2>&1
